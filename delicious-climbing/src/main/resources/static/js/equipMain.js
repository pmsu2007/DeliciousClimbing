...
function handleInputLength(el, max) {
  ...
  function filterTradeStatus(){
      var elements = document.getElementsByClassName("falseComponent"); // 클래스가 "falseComponent"인 모든 요소 선택
      var tradeStatusBtn = document.getElementById("tradeStatusBtn");
      ...
      if(clickCnt == 0){
          clickCnt++;
         tradeStatusBtn.innerHTML = "전체 보기";
      } else if(clickCnt == 1){
          clickCnt--;
          tradeStatusBtn.innerHTML = "판매중인 글만 보기";
      }
